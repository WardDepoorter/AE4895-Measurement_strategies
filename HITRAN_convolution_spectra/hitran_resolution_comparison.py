...
MOLEC_CH4   = 6
MOLEC_C2H6  = 27
MOLEC_MASS  = {6: 16.043, 27: 30.069}   # g/mol (main isotopologue)
...
def main(parfile):
    ...
    RESOLUTIONS = [100_000, 10_000, 1_000, 200]
    ...
    MOL_COLS  = {MOLEC_CH4: '#60a5fa', MOLEC_C2H6: '#fb923c'}
    ...
    fig.suptitle(
        'CH₄ vs C₂H₆  —  Absorption Cross-Section from HITRAN Line Data\n'
    ...
    outpath = '/mnt/user-data/outputs/hitran_ch4_c2h6_resolution.png'
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python3 hitran_plot.py <path_to_combined.par>")
        sys.exit(1)
    main(sys.argv[1])
